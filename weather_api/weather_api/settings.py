...
SECRET_KEY = 'django-insecure-(x$!1_08hzv^9i2j)dlbfwomtzaza-n$__ofnj+0mveq&vd*y$'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'rest_framework.authentication.BasicAuthentication',  # Enables username/password auth
